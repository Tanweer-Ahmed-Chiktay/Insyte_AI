...
export function EmailDashboardOriginal() {
  ...
  const sidebarItems = [
    ...
    { id: 'promotions', label: 'Promotions', icon: Tag, count: emails.filter(e => (e.labelIds?.includes('CATEGORY_PROMOTIONS') || (e as any).labels?.includes('CATEGORY_PROMOTIONS'))).length },
